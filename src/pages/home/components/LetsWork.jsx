...
export const LetsWork = () => {
  return (
    <section className="z-[95] rounded-tl-[0px] bg-[#000000] bg-opacity-[100%] pb-[80px] pt-[80px]">
      <div className=" font-plus-jakarta-sans py-[200px] text-center text-[128px] font-light leading-[1em] tracking-[-0.025em] text-[#FFFFFF] text-opacity-[100%] md:text-[60px]">
